 ...
 * 短信发送
 */
public class SendMassageSms {

    public static void main(String[] args) {

        SendCode("15867106139");
    }

    //对应你阿里云账户的 accessKeyId
    private static final String accessKeyId = "LTAI4FhHvVMA6kR1LBTP2AcD";

    //对应你阿里云账户的 accessKeySecret
    private static final String accessKeySecret = "SfHs42v5czgpRSBqn6KsGc9d4AJFVq";

    //对应签名名称
    private static final String signName="齐圣园区";

    //对应模板代码
    private static final String templateCode="SMS_182541290";
